...
func (_m *Cache) GetImage(value string, _a1 extension.Extension) (*entity.Image, error) {
	...
	var r0 *entity.Image
	var r1 error
	if rf, ok := ret.Get(0).(func(string, extension.Extension) (*entity.Image, error)); ok {
		return rf(value, _a1)
	}
	if rf, ok := ret.Get(0).(func(string, extension.Extension) *entity.Image); ok {
		r0 = rf(value, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, extension.Extension) error); ok {
		r1 = rf(value, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Cache_GetImage_Call) Run(run func(value string, _a1 extension.Extension)) *Cache_GetImage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(extension.Extension))
	})
	return _c
}
...
func (_c *Cache_GetImage_Call) RunAndReturn(run func(string, extension.Extension) (*entity.Image, error)) *Cache_GetImage_Call {
	_c.Call.Return(run)
	return _c
}

// LoadImage provides a mock function with given fields: value, _a1
func (_m *Cache) LoadImage(value string, _a1 extension.Extension) error {
	ret := _m.Called(value, _a1)
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(string, extension.Extension) error); ok {
		r0 = rf(value, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Cache_LoadImage_Call) Run(run func(value string, _a1 extension.Extension)) *Cache_LoadImage_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(extension.Extension))
	})
	return _c
...
func (_c *Cache_LoadImage_Call) RunAndReturn(run func(string, extension.Extension) error) *Cache_LoadImage_Call {
	_c.Call.Return(run)
	return _c
}
