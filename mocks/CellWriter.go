...
import (
	...
	cellwriter "github.com/pchchv/bpdf/internal/providers/gofpdf/cellwriter"
...
func (_m *CellWriter) Apply(width float64, height float64, config *entity.Config, prop *properties.Cell) {
...
func (_c *CellWriter_Apply_Call) Run(run func(width float64, height float64, config *entity.Config, prop *properties.Cell)) *CellWriter_Apply_Call {
...
func (_c *CellWriter_Apply_Call) RunAndReturn(run func(float64, float64, *entity.Config, *properties.Cell)) *CellWriter_Apply_Call {
	_c.Call.Return(run)
	return _c
}
