...
func (_m *Code) GenBar(code string, cell *entity.Cell, prop *properties.Barcode) (*entity.Image, error) {
	...
	var r0 *entity.Image
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *entity.Cell, *properties.Barcode) (*entity.Image, error)); ok {
		return rf(code, cell, prop)
	}
	if rf, ok := ret.Get(0).(func(string, *entity.Cell, *properties.Barcode) *entity.Image); ok {
	...
	if rf, ok := ret.Get(1).(func(string, *entity.Cell, *properties.Barcode) error); ok {
...
func (_c *Code_GenBar_Call) Run(run func(code string, cell *entity.Cell, prop *properties.Barcode)) *Code_GenBar_Call {
...
func (_c *Code_GenBar_Call) RunAndReturn(run func(string, *entity.Cell, *properties.Barcode) (*entity.Image, error)) *Code_GenBar_Call {
	_c.Call.Return(run)
	return _c
}
