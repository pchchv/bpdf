...
func (_m *Col) WithStyle(style *properties.Cell) core.Col {
	ret := _m.Called(style)
	...
	var r0 core.Col
	if rf, ok := ret.Get(0).(func(*properties.Cell) core.Col); ok {
		r0 = rf(style)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(core.Col)
...
func (_c *Col_WithStyle_Call) Run(run func(style *properties.Cell)) *Col_WithStyle_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Col_WithStyle_Call) RunAndReturn(run func(*properties.Cell) core.Col) *Col_WithStyle_Call {
	_c.Call.Return(run)
	return _c
}
