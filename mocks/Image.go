...
func (_m *Image) Add(img *entity.Image, cell *entity.Cell, margins *entity.Margins, prop *properties.Rect, _a4 extension.Extension, flow bool) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(*entity.Image, *entity.Cell, *entity.Margins, *properties.Rect, extension.Extension, bool) error); ok {
...
func (_c *Image_Add_Call) Run(run func(img *entity.Image, cell *entity.Cell, margins *entity.Margins, prop *properties.Rect, _a4 extension.Extension, flow bool)) *Image_Add_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*entity.Image), args[1].(*entity.Cell), args[2].(*entity.Margins), args[3].(*properties.Rect), args[4].(extension.Extension), args[5].(bool))
	})
	return _c
}
...
func (_c *Image_Add_Call) RunAndReturn(run func(*entity.Image, *entity.Cell, *entity.Margins, *properties.Rect, extension.Extension, bool) error) *Image_Add_Call {
	_c.Call.Return(run)
	return _c
}

// GetImageInfo provides a mock function with given fields: img, _a1
func (_m *Image) GetImageInfo(img *entity.Image, _a1 extension.Extension) (*gofpdf.ImageInfoType, uuid.UUID) {
	...
	var r1 uuid.UUID
	if rf, ok := ret.Get(0).(func(*entity.Image, extension.Extension) (*gofpdf.ImageInfoType, uuid.UUID)); ok {
		return rf(img, _a1)
	}
	if rf, ok := ret.Get(0).(func(*entity.Image, extension.Extension) *gofpdf.ImageInfoType); ok {
		r0 = rf(img, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(*entity.Image, extension.Extension) uuid.UUID); ok {
		r1 = rf(img, _a1)
	} else {
		if ret.Get(1) != nil {
...
func (_c *Image_GetImageInfo_Call) Run(run func(img *entity.Image, _a1 extension.Extension)) *Image_GetImageInfo_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*entity.Image), args[1].(extension.Extension))
	})
	return _c
}
...
func (_c *Image_GetImageInfo_Call) RunAndReturn(run func(*entity.Image, extension.Extension) (*gofpdf.ImageInfoType, uuid.UUID)) *Image_GetImageInfo_Call {
	_c.Call.Return(run)
	return _c
}
