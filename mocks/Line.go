...
func (_m *Line) Add(cell *entity.Cell, prop *properties.Line) {
	_m.Called(cell, prop)
}
...
func (_c *Line_Add_Call) Run(run func(cell *entity.Cell, prop *properties.Line)) *Line_Add_Call {
...
func (_c *Line_Add_Call) RunAndReturn(run func(*entity.Cell, *properties.Line)) *Line_Add_Call {
	_c.Call.Return(run)
	return _c
}
