...
import (
	extension "github.com/pchchv/bpdf/consts/extension"
	entity "github.com/pchchv/bpdf/core/entity"

	mock "github.com/stretchr/testify/mock"

	properties "github.com/pchchv/bpdf/properties"
)
...
func (_m *Provider) AddBackgroundImageFromBytes(bytes []byte, cell *entity.Cell, prop *properties.Rect, _a3 extension.Extension) {
...
func (_c *Provider_AddBackgroundImageFromBytes_Call) Run(run func(bytes []byte, cell *entity.Cell, prop *properties.Rect, _a3 extension.Extension)) *Provider_AddBackgroundImageFromBytes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte), args[1].(*entity.Cell), args[2].(*properties.Rect), args[3].(extension.Extension))
	})
	return _c
}
...
func (_c *Provider_AddBackgroundImageFromBytes_Call) RunAndReturn(run func([]byte, *entity.Cell, *properties.Rect, extension.Extension)) *Provider_AddBackgroundImageFromBytes_Call {
	_c.Call.Return(run)
	return _c
}

// AddBarCode provides a mock function with given fields: code, cell, prop
func (_m *Provider) AddBarCode(code string, cell *entity.Cell, prop *properties.Barcode) {
...
func (_c *Provider_AddBarCode_Call) Run(run func(code string, cell *entity.Cell, prop *properties.Barcode)) *Provider_AddBarCode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*entity.Cell), args[2].(*properties.Barcode))
	})
	return _c
}
...
func (_c *Provider_AddBarCode_Call) RunAndReturn(run func(string, *entity.Cell, *properties.Barcode)) *Provider_AddBarCode_Call {
	_c.Call.Return(run)
	return _c
}

// AddImageFromBytes provides a mock function with given fields: bytes, cell, prop, _a3
func (_m *Provider) AddImageFromBytes(bytes []byte, cell *entity.Cell, prop *properties.Rect, _a3 extension.Extension) {
	_m.Called(bytes, cell, prop, _a3)
}
...
func (_c *Provider_AddImageFromBytes_Call) Run(run func(bytes []byte, cell *entity.Cell, prop *properties.Rect, _a3 extension.Extension)) *Provider_AddImageFromBytes_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte), args[1].(*entity.Cell), args[2].(*properties.Rect), args[3].(extension.Extension))
	})
	return _c
...
func (_c *Provider_AddImageFromBytes_Call) RunAndReturn(run func([]byte, *entity.Cell, *properties.Rect, extension.Extension)) *Provider_AddImageFromBytes_Call {
	_c.Call.Return(run)
	return _c
}

// AddImageFromFile provides a mock function with given fields: value, cell, prop
func (_m *Provider) AddImageFromFile(value string, cell *entity.Cell, prop *properties.Rect) {
...
func (_c *Provider_AddImageFromFile_Call) Run(run func(value string, cell *entity.Cell, prop *properties.Rect)) *Provider_AddImageFromFile_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*entity.Cell), args[2].(*properties.Rect))
	})
	return _c
}
...
func (_c *Provider_AddImageFromFile_Call) RunAndReturn(run func(string, *entity.Cell, *properties.Rect)) *Provider_AddImageFromFile_Call {
	_c.Call.Return(run)
	return _c
}

// AddLine provides a mock function with given fields: cell, prop
func (_m *Provider) AddLine(cell *entity.Cell, prop *properties.Line) {
	_m.Called(cell, prop)
}
...
func (_c *Provider_AddLine_Call) Run(run func(cell *entity.Cell, prop *properties.Line)) *Provider_AddLine_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*entity.Cell), args[1].(*properties.Line))
	})
	return _c
}
...
func (_c *Provider_AddLine_Call) RunAndReturn(run func(*entity.Cell, *properties.Line)) *Provider_AddLine_Call {
	_c.Call.Return(run)
	return _c
}

// AddMatrixCode provides a mock function with given fields: code, cell, prop
func (_m *Provider) AddMatrixCode(code string, cell *entity.Cell, prop *properties.Rect) {
	_m.Called(code, cell, prop)
}
...
func (_c *Provider_AddMatrixCode_Call) Run(run func(code string, cell *entity.Cell, prop *properties.Rect)) *Provider_AddMatrixCode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*entity.Cell), args[2].(*properties.Rect))
	})
	return _c
...
func (_c *Provider_AddMatrixCode_Call) RunAndReturn(run func(string, *entity.Cell, *properties.Rect)) *Provider_AddMatrixCode_Call {
	_c.Call.Return(run)
	return _c
}

// AddQrCode provides a mock function with given fields: code, cell, rect
func (_m *Provider) AddQrCode(code string, cell *entity.Cell, rect *properties.Rect) {
...
func (_c *Provider_AddQrCode_Call) Run(run func(code string, cell *entity.Cell, rect *properties.Rect)) *Provider_AddQrCode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*entity.Cell), args[2].(*properties.Rect))
	})
	return _c
...
func (_c *Provider_AddQrCode_Call) RunAndReturn(run func(string, *entity.Cell, *properties.Rect)) *Provider_AddQrCode_Call {
	_c.Call.Return(run)
	return _c
}

// AddText provides a mock function with given fields: text, cell, prop
func (_m *Provider) AddText(text string, cell *entity.Cell, prop *properties.Text) {
...
func (_c *Provider_AddText_Call) Run(run func(text string, cell *entity.Cell, prop *properties.Text)) *Provider_AddText_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*entity.Cell), args[2].(*properties.Text))
	})
	return _c
}
...
func (_c *Provider_AddText_Call) RunAndReturn(run func(string, *entity.Cell, *properties.Text)) *Provider_AddText_Call {
	_c.Call.Return(run)
	return _c
}

// CreateCol provides a mock function with given fields: width, height, config, prop
func (_m *Provider) CreateCol(width float64, height float64, config *entity.Config, prop *properties.Cell) {
...
func (_c *Provider_CreateCol_Call) Run(run func(width float64, height float64, config *entity.Config, prop *properties.Cell)) *Provider_CreateCol_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(float64), args[1].(float64), args[2].(*entity.Config), args[3].(*properties.Cell))
	})
	return _c
}
...
func (_c *Provider_CreateCol_Call) RunAndReturn(run func(float64, float64, *entity.Config, *properties.Cell)) *Provider_CreateCol_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Provider) GetDimensionsByImageByte(bytes []byte, _a1 extension.Extension) (*entity.Dimensions, error) {
	...
	var r0 *entity.Dimensions
	var r1 error
	if rf, ok := ret.Get(0).(func([]byte, extension.Extension) (*entity.Dimensions, error)); ok {
		return rf(bytes, _a1)
	}
	if rf, ok := ret.Get(0).(func([]byte, extension.Extension) *entity.Dimensions); ok {
		r0 = rf(bytes, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*entity.Dimensions)
	...
	if rf, ok := ret.Get(1).(func([]byte, extension.Extension) error); ok {
		r1 = rf(bytes, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Provider_GetDimensionsByImageByte_Call) Run(run func(bytes []byte, _a1 extension.Extension)) *Provider_GetDimensionsByImageByte_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([]byte), args[1].(extension.Extension))
	})
	return _c
}
...
func (_c *Provider_GetDimensionsByImageByte_Call) RunAndReturn(run func([]byte, extension.Extension) (*entity.Dimensions, error)) *Provider_GetDimensionsByImageByte_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Provider) GetFontHeight(prop *properties.Font) float64 {
	ret := _m.Called(prop)
	...
	var r0 float64
	if rf, ok := ret.Get(0).(func(*properties.Font) float64); ok {
		r0 = rf(prop)
	} else {
...
func (_c *Provider_GetFontHeight_Call) Run(run func(prop *properties.Font)) *Provider_GetFontHeight_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*properties.Font))
	})
	return _c
}
...
func (_c *Provider_GetFontHeight_Call) RunAndReturn(run func(*properties.Font) float64) *Provider_GetFontHeight_Call {
	_c.Call.Return(run)
	return _c
}

// GetLinesQuantity provides a mock function with given fields: text, textProp, colWidth
func (_m *Provider) GetLinesQuantity(text string, textProp *properties.Text, colWidth float64) int {
	...
	var r0 int
	if rf, ok := ret.Get(0).(func(string, *properties.Text, float64) int); ok {
...
func (_c *Provider_GetLinesQuantity_Call) Run(run func(text string, textProp *properties.Text, colWidth float64)) *Provider_GetLinesQuantity_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*properties.Text), args[2].(float64))
	})
	return _c
}
...
func (_c *Provider_GetLinesQuantity_Call) RunAndReturn(run func(string, *properties.Text, float64) int) *Provider_GetLinesQuantity_Call {
	_c.Call.Return(run)
	return _c
}
