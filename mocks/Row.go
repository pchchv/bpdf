...
func (_m *Row) WithStyle(style *properties.Cell) core.Row {
	ret := _m.Called(style)
	...
	var r0 core.Row
	if rf, ok := ret.Get(0).(func(*properties.Cell) core.Row); ok {
		r0 = rf(style)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(core.Row)
...
func (_c *Row_WithStyle_Call) Run(run func(style *properties.Cell)) *Row_WithStyle_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*properties.Cell))
	})
	return _c
}
...
func (_c *Row_WithStyle_Call) RunAndReturn(run func(*properties.Cell) core.Row) *Row_WithStyle_Call {
	_c.Call.Return(run)
	return _c
}
